...
public abstract class Piso {
    ...
    protected void cheatsMenu() {
        while (true) {
            ...
            if ("A".equals(c)) { 
                p.cheatInfiniteHealth = !p.cheatInfiniteHealth; 
                System.out.println("Vida infinita -> " + p.cheatInfiniteHealth); 
            } else if ("B".equals(c)) { 
                p.cheatOneHitKill = !p.cheatOneHitKill; 
                System.out.println("OneHitKill -> " + p.cheatOneHitKill); 
            } else if ("C".equals(c)) { 
                p.cheatSkipRooms = !p.cheatSkipRooms; 
                System.out.println("Saltar salas -> " + p.cheatSkipRooms); 
